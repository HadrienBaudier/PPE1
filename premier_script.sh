#!/usr/bin/bash
cd /home/hadrien/Downloads/Fichiers
echo "où suis-je ?"
pwd
...
#traitement de l'année 2017, on écrit à la suite du fichier sortie.txt
echo "pour l'année 2017" >> sortie.txt
grep "Location" 2017*.ann | wc -l >> sortie.txt
# traitement de l'année	2018, on écrit à la suite du fichier sortie.txt
